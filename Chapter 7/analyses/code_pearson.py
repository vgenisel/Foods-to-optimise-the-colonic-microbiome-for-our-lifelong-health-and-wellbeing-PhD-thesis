...
plot_all = (
    ...
    + geom_text(
        ...
        color="black",))
plot_all
plot_all.save('results/plot_all_samples.tiff',dpi = 600)
...
plot_reduced = (
    ...
    + geom_text(
        ...
        color="black",))
plot_reduced
plot_reduced.save('results/plot_food_food-food.tiff',dpi = 600)
...
plot_food = (
    ...
    + geom_text(
        ...
        color="black",))
plot_food
plot_food.save('results/plot_food.tiff',dpi = 600)
...
plot_food_formula = (
    ...
    + geom_text(
        ...
        color="black",))
plot_food_formula
plot_food_formula.save('results/plot_food_formula.tiff',dpi = 600)
...
plot_food_food = (
    ...
    + geom_text(
        ...
        color="black",))
plot_food_food
plot_food_food.save('results/plot_food_food.tiff',dpi = 600)
...
plot_food_food_formula = (
    ...
    + geom_text(
        ...
        color="black",))
plot_food_food_formula
plot_food_food_formula.save('results/plot_food_food_formula.tiff',dpi = 600)
...
plot_plant = (
    ...
    + geom_text(
        ...
        color="black",))
plot_plant
plot_plant.save('results/plot_plant.tiff',dpi = 600)