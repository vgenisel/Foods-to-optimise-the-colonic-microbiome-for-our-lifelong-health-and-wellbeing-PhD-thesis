...
num_samples = len(averge_data['Sample'].unique())
...
for i, sample in enumerate(averge_data['Sample'].unique()):
    subset = averge_data[averge_data['Sample'] == sample].set_index('Analyte')
