...
import pandas as pd
tax = pd.read_csv('data/relative_abundances_post_fermentation.csv') #relative abundaces post-fermentation for all samples

#Splitting dataframe for each sample
tax_samples = {sample: data for sample, data in tax.groupby('sample_id')}

foods = [
    "Black_beans",
    "Black_beans_and_Blackcurrant",
    "Black_beans_and_Blackcurrant_and_formula",
    "Black_beans_and_Pumpkin",
    "Black_beans_and_Pumpkin_and_formula",
    "Black_beans_and_formula",
    "Blackcurrant",
    "Blackcurrant_and_Kumara_peeled",
    "Blackcurrant_and_Kumara_peeled_and_formula",
    "Blackcurrant_and_Kumara_with_skin",
    "Blackcurrant_and_Kumara_with_skin_and_formula",
    "Blackcurrant_and_Pork",
    "Blackcurrant_and_Pork_and_formula",
    "Blackcurrant_and_Soybean",
    "Blackcurrant_and_Soybean_and_formula",
    "Blackcurrant_and_Strawberries",
    "Blackcurrant_and_Strawberries_and_formula",
    "Blackcurrant_and_formula",
    "Chickpea",
    "Chickpea_and_Pork",
    "Chickpea_and_Pork_and_formula",
    "Chickpea_and_Yellow_peas",
    "Chickpea_and_Yellow_peas_and_formula",
    "Chickpea_and_formula",
    "Couscous",
    "Couscous_and_Pork",
    "Couscous_and_Pork_and_formula",
    "Couscous_and_Pumpkin",
    "Couscous_and_Pumpkin_and_formula",
    "Couscous_and_formula",
    "Infant_formula",
    "Kumara_peeled",
    "Kumara_peeled_and_formula",
    "Kumara_with_skin",
    "Kumara_with_skin_and_formula",
    "Pork",
    "Pork_and_Raspberries",
    "Pork_and_Raspberries_and_formula",
    "Pork_and_formula",
    "Prawn",
    "Prawn_and_formula",
    "Pumpkin",
    "Pumpkin_and_Yellow_peas",
    "Pumpkin_and_Yellow_peas_and_formula",
    "Pumpkin_and_formula",
    "Raspberries",
    "Raspberries_and_formula",
    "Soybean",
    "Soybean_and_formula",
    "Strawberries",
    "Strawberries_and_formula",
    "Yellow_peas",
    "Yellow_peas_and_formula"
]

# Loop to create one DataFrame per food
for food in foods:
    var_name = f"tax_{food}"
    if food in tax_samples:
        globals()[var_name] = tax_samples[food]

#Building models using AGORA2 reconstructions
from micom.workflows import build
import pandas as pd
manifest_black_beans = build(tax_Black_beans, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_black_beans_and_blackcurrant = build(tax_Black_beans_and_Blackcurrant, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_black_beans_and_blackcurrant_and_formula = build(tax_Black_beans_and_Blackcurrant_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_black_beans_and_pumpkin = build(tax_Black_beans_and_Pumpkin, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_black_beans_and_pumpkin_and_formula = build(tax_Black_beans_and_Pumpkin_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_black_beans_and_formula = build(tax_Black_beans_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant = build(tax_Blackcurrant, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_kumara_peeled = build(tax_Blackcurrant_and_Kumara_peeled, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_kumara_peeled_and_formula = build(tax_Blackcurrant_and_Kumara_peeled_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_kumara_with_skin = build(tax_Blackcurrant_and_Kumara_with_skin, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_kumara_with_skin_and_formula = build(tax_Blackcurrant_and_Kumara_with_skin_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_pork = build(tax_Blackcurrant_and_Pork, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_pork_and_formula = build(tax_Blackcurrant_and_Pork_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_soybean = build(tax_Blackcurrant_and_Soybean, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_soybean_and_formula = build(tax_Blackcurrant_and_Soybean_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_strawberries = build(tax_Blackcurrant_and_Strawberries, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_strawberries_and_formula = build(tax_Blackcurrant_and_Strawberries_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_blackcurrant_and_formula = build(tax_Blackcurrant_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_chickpea = build(tax_Chickpea, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_chickpea_and_pork = build(tax_Chickpea_and_Pork, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_chickpea_and_pork_and_formula = build(tax_Chickpea_and_Pork_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_chickpea_and_yellow_peas = build(tax_Chickpea_and_Yellow_peas, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_chickpea_and_yellow_peas_and_formula = build(tax_Chickpea_and_Yellow_peas_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_chickpea_and_formula = build(tax_Chickpea_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_couscous = build(tax_Couscous, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_couscous_and_pork = build(tax_Couscous_and_Pork, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_couscous_and_pork_and_formula = build(tax_Couscous_and_Pork_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_couscous_and_pumpkin = build(tax_Couscous_and_Pumpkin, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_couscous_and_pumpkin_and_formula = build(tax_Couscous_and_Pumpkin_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_couscous_and_formula = build(tax_Couscous_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_infant_formula = build(tax_Infant_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_kumara_peeled = build(tax_Kumara_peeled, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_kumara_peeled_and_formula = build(tax_Kumara_peeled_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_kumara_with_skin = build(tax_Kumara_with_skin, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_kumara_with_skin_and_formula = build(tax_Kumara_with_skin_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pork = build(tax_Pork, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pork_and_raspberries = build(tax_Pork_and_Raspberries, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pork_and_raspberries_and_formula = build(tax_Pork_and_Raspberries_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pork_and_formula = build(tax_Pork_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_prawn = build(tax_Prawn, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_prawn_and_formula = build(tax_Prawn_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pumpkin = build(tax_Pumpkin, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pumpkin_and_yellow_peas = build(tax_Pumpkin_and_Yellow_peas, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pumpkin_and_yellow_peas_and_formula = build(tax_Pumpkin_and_Yellow_peas_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_pumpkin_and_formula = build(tax_Pumpkin_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_raspberries = build(tax_Raspberries, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_raspberries_and_formula = build(tax_Raspberries_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_soybean = build(tax_Soybean, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_soybean_and_formula = build(tax_Soybean_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_strawberries = build(tax_Strawberries, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_strawberries_and_formula = build(tax_Strawberries_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_yellow_peas = build(tax_Yellow_peas, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
manifest_yellow_peas_and_formula = build(tax_Yellow_peas_and_formula, model_db="data/agora201_genus_1.qza", out_folder="models_cplex", solver="cplex", cutoff=0.001, threads=14)
...
tradeoff_black_beans = tradeoff(manifest_black_beans, model_folder="models_cplex", medium=black_beans, threads=14) 
plot_tradeoff(tradeoff_black_beans, filename="results/tradeoff_black_beans.html")
tradeoff_blackcurrants = tradeoff(manifest_blackcurrant, model_folder="models_cplex", medium=blackcurrants, threads=14) 
plot_tradeoff(tradeoff_blackcurrants, filename="results/tradeoff_blackcurrants.html")
tradeoff_chickpeas = tradeoff(manifest_chickpea, model_folder="models_cplex", medium=chickpeas, threads=14) 
plot_tradeoff(tradeoff_chickpeas, filename="results/tradeoff_chickpeas.html")
tradeoff_couscous = tradeoff(manifest_couscous, model_folder="models_cplex", medium=couscous, threads=14) 
plot_tradeoff(tradeoff_couscous, filename="results/tradeoff_couscous.html")
tradeoff_infant_formula = tradeoff(manifest_infant_formula, model_folder="models_cplex", medium=infant_formula, threads=14) 
plot_tradeoff(tradeoff_infant_formula, filename="results/tradeoff_infant_formula.html")
tradeoff_kumara_with_skin = tradeoff(manifest_kumara_with_skin, model_folder="models_cplex", medium=kumara_with_skin, threads=14) 
plot_tradeoff(tradeoff_kumara_with_skin, filename="results/tradeoff_kumara_with_skin.html")
tradeoff_kumara_without_skin = tradeoff(manifest_kumara_peeled, model_folder="models_cplex", medium=kumara_without_skin, threads=14) 
plot_tradeoff(tradeoff_kumara_without_skin, filename="results/tradeoff_kumara_without_skin.html")
tradeoff_pork = tradeoff(manifest_pork, model_folder="models_cplex", medium=pork, threads=14) 
plot_tradeoff(tradeoff_pork, filename="results/tradeoff_pork.html")
tradeoff_prawn = tradeoff(manifest_prawn, model_folder="models_cplex", medium=prawn, threads=14) 
plot_tradeoff(tradeoff_prawn, filename="results/tradeoff_prawn.html")
tradeoff_pumpkin = tradeoff(manifest_pumpkin, model_folder="models_cplex", medium=pumpkin, threads=14) 
plot_tradeoff(tradeoff_pumpkin, filename="results/tradeoff_pumpkin.html")
tradeoff_raspberries = tradeoff(manifest_raspberries, model_folder="models_cplex", medium=raspberries, threads=14) 
plot_tradeoff(tradeoff_raspberries, filename="results/tradeoff_raspberries.html")
tradeoff_soybeans = tradeoff(manifest_soybean, model_folder="models_cplex", medium=soybeans, threads=14) 
plot_tradeoff(tradeoff_soybeans, filename="results/tradeoff_soybeans.html")
tradeoff_strawberries = tradeoff(manifest_strawberries, model_folder="models_cplex", medium=strawberries, threads=14) 
plot_tradeoff(tradeoff_strawberries, filename="results/tradeoff_strawberries.html")
tradeoff_yellow_peas = tradeoff(manifest_yellow_peas, model_folder="models_cplex", medium=yellow_peas, threads=14) 
plot_tradeoff(tradeoff_yellow_peas, filename="results/tradeoff_yellow_peas.html")
tradeoff_formula_black_beans = tradeoff(manifest_black_beans_and_formula, model_folder="models_cplex", medium=formula_black_beans, threads=14) 
plot_tradeoff(tradeoff_formula_black_beans, filename="results/tradeoff_formula_black_beans.html")
tradeoff_formula_blackcurrants = tradeoff(manifest_blackcurrant_and_formula, model_folder="models_cplex", medium=formula_blackcurrants, threads=14) 
plot_tradeoff(tradeoff_formula_blackcurrants, filename="results/tradeoff_formula_blackcurrants.html")
tradeoff_formula_chickpeas = tradeoff(manifest_chickpea_and_formula, model_folder="models_cplex", medium=formula_chickpeas, threads=14) 
plot_tradeoff(tradeoff_formula_chickpeas, filename="results/tradeoff_formula_chickpeas.html")
tradeoff_formula_couscous = tradeoff(manifest_couscous_and_formula, model_folder="models_cplex", medium=formula_couscous, threads=14) 
plot_tradeoff(tradeoff_formula_couscous, filename="results/tradeoff_formula_couscous.html")
tradeoff_formula_kumara_with_skin = tradeoff(manifest_kumara_with_skin_and_formula, model_folder="models_cplex", medium=formula_kumara_with_skin, threads=14) 
plot_tradeoff(tradeoff_formula_kumara_with_skin, filename="results/tradeoff_formula_kumara_with_skin.html")
tradeoff_formula_kumara_without_skin = tradeoff(manifest_kumara_peeled_and_formula, model_folder="models_cplex", medium=formula_kumara_without_skin, threads=14) 
plot_tradeoff(tradeoff_formula_kumara_without_skin, filename="results/tradeoff_formula_kumara_without_skin.html")
tradeoff_formula_pork = tradeoff(manifest_pork_and_formula, model_folder="models_cplex", medium=formula_pork, threads=14) 
plot_tradeoff(tradeoff_formula_pork, filename="results/tradeoff_formula_pork.html")
tradeoff_formula_prawn = tradeoff(manifest_prawn_and_formula, model_folder="models_cplex", medium=formula_prawn, threads=14) 
plot_tradeoff(tradeoff_formula_prawn, filename="results/tradeoff_formula_prawn.html")
tradeoff_formula_pumpkin = tradeoff(manifest_pumpkin_and_formula, model_folder="models_cplex", medium=formula_pumpkin, threads=14) 
plot_tradeoff(tradeoff_formula_pumpkin, filename="results/tradeoff_formula_pumpkin.html")
tradeoff_formula_raspberries = tradeoff(manifest_raspberries_and_formula, model_folder="models_cplex", medium=formula_raspberries, threads=14) 
plot_tradeoff(tradeoff_formula_raspberries, filename="results/tradeoff_formula_raspberries.html")
tradeoff_formula_soybeans = tradeoff(manifest_soybean_and_formula, model_folder="models_cplex", medium=formula_soybeans, threads=14) 
plot_tradeoff(tradeoff_formula_soybeans, filename="results/tradeoff_formula_soybeans.html")
tradeoff_formula_strawberries = tradeoff(manifest_strawberries_and_formula, model_folder="models_cplex", medium=formula_strawberries, threads=14) 
plot_tradeoff(tradeoff_formula_strawberries, filename="results/tradeoff_formula_strawberries.html")
tradeoff_formula_yellow_peas = tradeoff(manifest_yellow_peas_and_formula, model_folder="models_cplex", medium=formula_yellow_peas, threads=14) 
plot_tradeoff(tradeoff_formula_yellow_peas, filename="results/tradeoff_formula_yellow_peas.html")
tradeoff_black_beans_blackcurrants = tradeoff(manifest_black_beans_and_blackcurrant, model_folder="models_cplex", medium=black_beans_blackcurrants, threads=14) 
plot_tradeoff(tradeoff_black_beans_blackcurrants, filename="results/tradeoff_black_beans_blackcurrants.html")
tradeoff_black_beans_pumpkin = tradeoff(manifest_black_beans_and_pumpkin, model_folder="models_cplex", medium=black_beans_pumpkin, threads=14) 
plot_tradeoff(tradeoff_black_beans_pumpkin, filename="results/tradeoff_black_beans_pumpkin.html")
tradeoff_blackcurrants_kumara_with_skin = tradeoff(manifest_blackcurrant_and_kumara_with_skin, model_folder="models_cplex", medium=blackcurrants_kumara_with_skin, threads=14) 
plot_tradeoff(tradeoff_blackcurrants_kumara_with_skin, filename="results/tradeoff_blackcurrants_kumara_with_skin.html")
tradeoff_blackcurrants_kumara_without_skin = tradeoff(manifest_blackcurrant_and_kumara_peeled, model_folder="models_cplex", medium=blackcurrants_kumara_without_skin, threads=14) 
...
tradeoff_blackcurrants_pork = tradeoff(manifest_blackcurrant_and_pork, model_folder="models_cplex", medium=blackcurrants_pork, threads=14) 
plot_tradeoff(tradeoff_blackcurrants_pork, filename="results/tradeoff_blackcurrants_pork.html")
tradeoff_blackcurrants_soybeans = tradeoff(manifest_blackcurrant_and_soybean, model_folder="models_cplex", medium=blackcurrants_soybeans, threads=14) 
plot_tradeoff(tradeoff_blackcurrants_soybeans, filename="results/tradeoff_blackcurrants_soybeans.html")
tradeoff_blackcurrants_strawberries = tradeoff(manifest_blackcurrant_and_strawberries, model_folder="models_cplex", medium=blackcurrants_strawberries, threads=14) 
plot_tradeoff(tradeoff_blackcurrants_strawberries, filename="results/tradeoff_blackcurrants_strawberries.html")
tradeoff_chickpeas_pork = tradeoff(manifest_chickpea_and_pork, model_folder="models_cplex", medium=chickpeas_pork, threads=14) 
plot_tradeoff(tradeoff_chickpeas_pork, filename="results/tradeoff_chickpeas_pork.html")
tradeoff_chickpeas_yellow_peas = tradeoff(manifest_chickpea_and_yellow_peas, model_folder="models_cplex", medium=chickpeas_yellow_peas, threads=14) 
plot_tradeoff(tradeoff_chickpeas_yellow_peas, filename="results/tradeoff_chickpeas_yellow_peas.html")
tradeoff_couscous_pork = tradeoff(manifest_couscous_and_pork, model_folder="models_cplex", medium=couscous_pork, threads=14) 
plot_tradeoff(tradeoff_couscous_pork, filename="results/tradeoff_couscous_pork.html")
tradeoff_couscous_pumpkin = tradeoff(manifest_couscous_and_pumpkin, model_folder="models_cplex", medium=couscous_pumpkin, threads=14) 
plot_tradeoff(tradeoff_couscous_pumpkin, filename="results/tradeoff_couscous_pumpkin.html")
tradeoff_pork_raspberries = tradeoff(manifest_pork_and_raspberries, model_folder="models_cplex", medium=pork_raspberries, threads=14) 
plot_tradeoff(tradeoff_pork_raspberries, filename="results/tradeoff_pork_raspberries.html")
tradeoff_pumpkin_yellow_peas = tradeoff(manifest_pumpkin_and_yellow_peas, model_folder="models_cplex", medium=pumpkin_yellow_peas, threads=14) 
plot_tradeoff(tradeoff_pumpkin_yellow_peas, filename="results/tradeoff_pumpkin_yellow_peas.html")
tradeoff_formula_black_beans_blackcurrants = tradeoff(manifest_black_beans_and_blackcurrant_and_formula, model_folder="models_cplex", medium=formula_black_beans_blackcurrants, threads=14) 
...
tradeoff_formula_black_beans_pumpkin = tradeoff(manifest_black_beans_and_pumpkin_and_formula, model_folder="models_cplex", medium=formula_black_beans_pumpkin, threads=14) 
plot_tradeoff(tradeoff_formula_black_beans_pumpkin, filename="results/tradeoff_formula_black_beans_pumpkin.html")
tradeoff_formula_blackcurrants_kumara_with_skin = tradeoff(manifest_blackcurrant_and_kumara_with_skin_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_kumara_with_skin, threads=14) 
...
tradeoff_formula_blackcurrants_kumara_without_skin = tradeoff(manifest_blackcurrant_and_kumara_peeled_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_kumara_without_skin, threads=14) 
...
tradeoff_formula_blackcurrants_pork = tradeoff(manifest_blackcurrant_and_pork_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_pork, threads=14) 
plot_tradeoff(tradeoff_formula_blackcurrants_pork, filename="results/tradeoff_formula_blackcurrants_pork.html")
tradeoff_formula_blackcurrants_soybeans = tradeoff(manifest_blackcurrant_and_soybean_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_soybeans, threads=14) 
plot_tradeoff(tradeoff_formula_blackcurrants_soybeans, filename="results/tradeoff_formula_blackcurrants_soybeans.html")
tradeoff_formula_blackcurrants_strawberries = tradeoff(manifest_blackcurrant_and_strawberries_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_strawberries, threads=14) 
...
tradeoff_formula_chickpeas_pork = tradeoff(manifest_chickpea_and_pork_and_formula, model_folder="models_cplex", medium=formula_chickpeas_pork, threads=14) 
plot_tradeoff(tradeoff_formula_chickpeas_pork, filename="results/tradeoff_formula_chickpeas_pork.html")
tradeoff_formula_chickpeas_yellow_peas = tradeoff(manifest_chickpea_and_yellow_peas_and_formula, model_folder="models_cplex", medium=formula_chickpeas_yellow_peas, threads=14) 
plot_tradeoff(tradeoff_formula_chickpeas_yellow_peas, filename="results/tradeoff_formula_chickpeas_yellow_peas.html")
tradeoff_formula_couscous_pork = tradeoff(manifest_couscous_and_pork_and_formula, model_folder="models_cplex", medium=formula_couscous_pork, threads=14) 
plot_tradeoff(tradeoff_formula_couscous_pork, filename="results/tradeoff_formula_couscous_pork.html")
tradeoff_formula_couscous_pumpkin = tradeoff(manifest_couscous_and_pumpkin_and_formula, model_folder="models_cplex", medium=formula_couscous_pumpkin, threads=14) 
plot_tradeoff(tradeoff_formula_couscous_pumpkin, filename="results/tradeoff_formula_couscous_pumpkin.html")
tradeoff_formula_pork_raspberries = tradeoff(manifest_pork_and_raspberries_and_formula, model_folder="models_cplex", medium=formula_pork_raspberries, threads=14) 
plot_tradeoff(tradeoff_formula_pork_raspberries, filename="results/tradeoff_formula_pork_raspberries.html")
tradeoff_formula_pumpkin_yellow_peas = tradeoff(manifest_pumpkin_and_yellow_peas_and_formula, model_folder="models_cplex", medium=formula_pumpkin_yellow_peas, threads=14) 
...
res_black_beans = grow(manifest_black_beans, model_folder="models_cplex", medium=black_beans, tradeoff=0.5, threads=14) 
save_results(res_black_beans, "results/black_beans.zip") 
res_blackcurrants = grow(manifest_blackcurrant, model_folder="models_cplex", medium=blackcurrants, tradeoff=0.7, threads=14) 
save_results(res_blackcurrants, "results/blackcurrants.zip")
res_chickpeas = grow(manifest_chickpea, model_folder="models_cplex", medium=chickpeas, tradeoff=0.5, threads=14) 
save_results(res_chickpeas, "results/chickpeas.zip") 
res_couscous = grow(manifest_couscous, model_folder="models_cplex", medium=couscous, tradeoff=0.6, threads=14) 
save_results(res_couscous, "results/couscous.zip")  
res_infant_formula = grow(manifest_infant_formula, model_folder="models_cplex", medium=infant_formula, tradeoff=0.7, threads=14) 
save_results(res_infant_formula, "results/infant_formula.zip") 
res_kumara_with_skin = grow(manifest_kumara_with_skin, model_folder="models_cplex", medium=kumara_with_skin, tradeoff=0.7, threads=14) 
save_results(res_kumara_with_skin, "results/kumara_with_skin.zip") 
res_kumara_without_skin = grow(manifest_kumara_peeled, model_folder="models_cplex", medium=kumara_without_skin, tradeoff=0.7, threads=14) 
save_results(res_kumara_without_skin, "results/kumara_without_skin.zip") 
res_pork = grow(manifest_pork, model_folder="models_cplex", medium=pork, tradeoff=0.6, threads=14) 
save_results(res_pork, "results/pork.zip")
res_prawn = grow(manifest_prawn, model_folder="models_cplex", medium=prawn, tradeoff=0.9, threads=14) 
save_results(res_prawn, "results/prawn.zip") 
res_pumpkin = grow(manifest_pumpkin, model_folder="models_cplex", medium=pumpkin, tradeoff=0.6, threads=14) 
save_results(res_pumpkin, "results/pumpkin.zip")  
res_raspberries = grow(manifest_raspberries, model_folder="models_cplex", medium=raspberries, tradeoff=0.7, threads=14) 
save_results(res_raspberries, "results/raspberries.zip") 
res_soybeans = grow(manifest_soybean, model_folder="models_cplex", medium=soybeans, tradeoff=0.7, threads=14) 
save_results(res_soybeans, "results/soybeans.zip") 
res_strawberries = grow(manifest_strawberries, model_folder="models_cplex", medium=strawberries, tradeoff=0.7, threads=14) 
save_results(res_strawberries, "results/strawberries.zip")
res_yellow_peas = grow(manifest_yellow_peas, model_folder="models_cplex", medium=yellow_peas, tradeoff=0.7, threads=14) 
save_results(res_yellow_peas, "results/yellow_peas.zip") 
res_formula_black_beans = grow(manifest_black_beans_and_formula, model_folder="models_cplex", medium=formula_black_beans, tradeoff=0.7, threads=14) 
save_results(res_formula_black_beans, "results/formula_black_beans.zip") 
res_formula_blackcurrants = grow(manifest_blackcurrant_and_formula, model_folder="models_cplex", medium=formula_blackcurrants, tradeoff=0.7, threads=14) 
save_results(res_formula_blackcurrants, "results/formula_blackcurrants.zip")
res_formula_chickpeas = grow(manifest_chickpea_and_formula, model_folder="models_cplex", medium=formula_chickpeas, tradeoff=0.6, threads=14) 
save_results(res_formula_chickpeas, "results/formula_chickpeas.zip") 
res_formula_couscous = grow(manifest_couscous_and_formula, model_folder="models_cplex", medium=formula_couscous, tradeoff=0.7, threads=14) 
save_results(res_formula_couscous, "results/formula_couscous.zip")  
res_formula_kumara_with_skin = grow(manifest_kumara_with_skin_and_formula, model_folder="models_cplex", medium=formula_kumara_with_skin, tradeoff=0.6, threads=14) 
save_results(res_formula_kumara_with_skin, "results/formula_kumara_with_skin.zip") 
res_formula_kumara_without_skin = grow(manifest_kumara_peeled_and_formula, model_folder="models_cplex", medium=formula_kumara_without_skin, tradeoff=0.5, threads=14) 
save_results(res_formula_kumara_without_skin, "results/formula_kumara_without_skin.zip") 
res_formula_pork = grow(manifest_pork_and_formula, model_folder="models_cplex", medium=formula_pork, tradeoff=0.8, threads=14) 
save_results(res_formula_pork, "results/formula_pork.zip")
res_formula_prawn = grow(manifest_prawn_and_formula, model_folder="models_cplex", medium=formula_prawn, tradeoff=0.5, threads=14) 
save_results(res_formula_prawn, "results/formula_prawn.zip") 
res_formula_pumpkin = grow(manifest_pumpkin_and_formula, model_folder="models_cplex", medium=formula_pumpkin, tradeoff=0.7, threads=14) 
save_results(res_formula_pumpkin, "results/formula_pumpkin.zip")  
res_formula_raspberries = grow(manifest_raspberries_and_formula, model_folder="models_cplex", medium=formula_raspberries, tradeoff=0.7, threads=14) 
save_results(res_formula_raspberries, "results/formula_raspberries.zip") 
res_formula_soybeans = grow(manifest_soybean_and_formula, model_folder="models_cplex", medium=formula_soybeans, tradeoff=0.7, threads=14) 
save_results(res_formula_soybeans, "results/formula_soybeans.zip") 
res_formula_strawberries = grow(manifest_strawberries_and_formula, model_folder="models_cplex", medium=formula_strawberries, tradeoff=0.7, threads=14) 
save_results(res_formula_strawberries, "results/formula_strawberries.zip")
res_formula_yellow_peas = grow(manifest_yellow_peas_and_formula, model_folder="models_cplex", medium=formula_yellow_peas, tradeoff=0.5, threads=14) 
save_results(res_formula_yellow_peas, "results/formula_yellow_peas.zip") 
res_black_beans_blackcurrants = grow(manifest_black_beans_and_blackcurrant, model_folder="models_cplex", medium=black_beans_blackcurrants, tradeoff=0.7, threads=14) 
save_results(res_black_beans_blackcurrants, "results/black_beans_blackcurrants.zip") 
res_black_beans_pumpkin = grow(manifest_black_beans_and_pumpkin, model_folder="models_cplex", medium=black_beans_pumpkin, tradeoff=0.7, threads=14) 
save_results(res_black_beans_pumpkin, "results/black_beans_pumpkin.zip")
res_blackcurrants_kumara_with_skin = grow(manifest_blackcurrant_and_kumara_with_skin, model_folder="models_cplex", medium=blackcurrants_kumara_with_skin, tradeoff=0.7, threads=14) 
save_results(res_blackcurrants_kumara_with_skin, "results/blackcurrants_kumara_with_skin.zip") 
res_blackcurrants_kumara_without_skin = grow(manifest_blackcurrant_and_kumara_peeled, model_folder="models_cplex", medium=blackcurrants_kumara_without_skin, tradeoff=0.7, threads=14) 
save_results(res_blackcurrants_kumara_without_skin, "results/blackcurrants_kumara_without_skin.zip")  
res_blackcurrants_pork = grow(manifest_blackcurrant_and_pork, model_folder="models_cplex", medium=blackcurrants_pork, tradeoff=0.8, threads=14) 
save_results(res_blackcurrants_pork, "results/blackcurrants_pork.zip") 
res_blackcurrants_soybeans = grow(manifest_blackcurrant_and_soybean, model_folder="models_cplex", medium=blackcurrants_soybeans, tradeoff=0.5, threads=14) 
save_results(res_blackcurrants_soybeans, "results/blackcurrants_soybeans.zip") 
res_blackcurrants_strawberries = grow(manifest_blackcurrant_and_strawberries, model_folder="models_cplex", medium=blackcurrants_strawberries, tradeoff=0.7, threads=14) 
save_results(res_blackcurrants_strawberries, "results/blackcurrants_strawberries.zip")
res_chickpeas_pork = grow(manifest_chickpea_and_pork, model_folder="models_cplex", medium=chickpeas_pork, tradeoff=0.5, threads=14) 
save_results(res_chickpeas_pork, "results/chickpeas_pork.zip") 
res_chickpeas_yellow_peas = grow(manifest_chickpea_and_yellow_peas, model_folder="models_cplex", medium=chickpeas_yellow_peas, tradeoff=0.7, threads=14) 
save_results(res_chickpeas_yellow_peas, "results/chickpeas_yellow_peas.zip")  
res_couscous_pork = grow(manifest_couscous_and_pork, model_folder="models_cplex", medium=couscous_pork, tradeoff=0.8, threads=14) 
save_results(res_couscous_pork, "results/couscous_pork.zip") 
res_couscous_pumpkin = grow(manifest_couscous_and_pumpkin, model_folder="models_cplex", medium=couscous_pumpkin, tradeoff=0.7, threads=14) 
save_results(res_couscous_pumpkin, "results/couscous_pumpkin.zip") 
res_pork_raspberries = grow(manifest_pork_and_raspberries, model_folder="models_cplex", medium=pork_raspberries, tradeoff=0.7, threads=14) 
save_results(res_pork_raspberries, "results/pork_raspberries.zip")
res_pumpkin_yellow_peas = grow(manifest_pumpkin_and_yellow_peas, model_folder="models_cplex", medium=pumpkin_yellow_peas, tradeoff=0.7, threads=14) 
save_results(res_pumpkin_yellow_peas, "results/pumpkin_yellow_peas.zip") 
res_formula_black_beans_blackcurrants = grow(manifest_black_beans_and_blackcurrant_and_formula, model_folder="models_cplex", medium=formula_black_beans_blackcurrants, tradeoff=0.7, threads=14) 
save_results(res_formula_black_beans_blackcurrants, "results/formula_black_beans_blackcurrants.zip") 
res_formula_black_beans_pumpkin = grow(manifest_black_beans_and_pumpkin_and_formula, model_folder="models_cplex", medium=formula_black_beans_pumpkin, tradeoff=0.7, threads=14) 
save_results(res_formula_black_beans_pumpkin, "results/formula_black_beans_pumpkin.zip")
res_formula_blackcurrants_kumara_with_skin = grow(manifest_blackcurrant_and_kumara_with_skin_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_kumara_with_skin, tradeoff=0.7, threads=14) 
save_results(res_formula_blackcurrants_kumara_with_skin, "results/formula_blackcurrants_kumara_with_skin.zip") 
res_formula_blackcurrants_kumara_without_skin = grow(manifest_blackcurrant_and_kumara_peeled_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_kumara_without_skin, tradeoff=0.5, threads=14) 
save_results(res_formula_blackcurrants_kumara_without_skin, "results/formula_blackcurrants_kumara_without_skin.zip")  
res_formula_blackcurrants_pork = grow(manifest_blackcurrant_and_pork_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_pork, tradeoff=0.6, threads=14) 
save_results(res_formula_blackcurrants_pork, "results/formula_blackcurrants_pork.zip") 
res_formula_blackcurrants_soybeans = grow(manifest_blackcurrant_and_soybean_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_soybeans, tradeoff=0.7, threads=14) 
save_results(res_formula_blackcurrants_soybeans, "results/formula_blackcurrants_soybeans.zip") 
res_formula_blackcurrants_strawberries = grow(manifest_blackcurrant_and_strawberries_and_formula, model_folder="models_cplex", medium=formula_blackcurrants_strawberries, tradeoff=0.7, threads=14) 
save_results(res_formula_blackcurrants_strawberries, "results/formula_blackcurrants_strawberries.zip")
res_formula_chickpeas_pork = grow(manifest_chickpea_and_pork_and_formula, model_folder="models_cplex", medium=formula_chickpeas_pork, tradeoff=0.6, threads=14) 
save_results(res_formula_chickpeas_pork, "results/formula_chickpeas_pork.zip") 
res_formula_chickpeas_yellow_peas = grow(manifest_chickpea_and_yellow_peas_and_formula, model_folder="models_cplex", medium=formula_chickpeas_yellow_peas, tradeoff=0.8, threads=14) 
save_results(res_formula_chickpeas_yellow_peas, "results/formula_chickpeas_yellow_peas.zip")  
res_formula_couscous_pork = grow(manifest_couscous_and_pork_and_formula, model_folder="models_cplex", medium=formula_couscous_pork, tradeoff=0.5, threads=14) 
save_results(res_formula_couscous_pork, "results/formula_couscous_pork.zip") 
res_formula_couscous_pumpkin = grow(manifest_couscous_and_pumpkin_and_formula, model_folder="models_cplex", medium=formula_couscous_pumpkin, tradeoff=0.7, threads=14) 
save_results(res_formula_couscous_pumpkin, "results/formula_couscous_pumpkin.zip") 
res_formula_pork_raspberries = grow(manifest_pork_and_raspberries_and_formula, model_folder="models_cplex", medium=formula_pork_raspberries, tradeoff=0.8, threads=14) 
save_results(res_formula_pork_raspberries, "results/formula_pork_raspberries.zip")
res_formula_pumpkin_yellow_peas = grow(manifest_pumpkin_and_yellow_peas_and_formula, model_folder="models_cplex", medium=formula_pumpkin_yellow_peas, tradeoff=0.6, threads=14) 
...
exchanges_reduced.to_csv("results/exchanges_food_reduced.csv")
